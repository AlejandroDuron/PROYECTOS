...
class cajaDeTextoModificable(QLineEdit):
    def __init__(self, altura = None, ancho = None, invisible = False, alineacion = Qt.AlignmentFlag.AlignLeft, ejemplo_texto = "", borde_color="#4a90e2", borde_ancho=2, radio=5, padding=5, alineacion_texto_caja="left", altura_fija = None):
        super().__init__()
        ...
        self.configurar(
            ...
            ejemplo_texto_caja = ejemplo_texto,
            borde_color_caja = borde_color,
            borde_ancho_caja = borde_ancho,
            radio_caja = radio,
            padding_caja = padding,
            alineacion_texto_caja = alineacion_texto_caja,
            altura_fija_caja = altura_fija
        )

    def configurar(self, altura_caja = None, ancho_caja = None, invisible_caja = False, alineacion_caja = Qt.AlignmentFlag.AlignLeft, ejemplo_texto_caja = "", borde_color_caja="Black", borde_ancho_caja=2, radio_caja=5, padding_caja=5, alineacion_texto_caja="left", altura_fija_caja = None):
        ...
        self.setPlaceholderText(ejemplo_texto_caja)

        if altura_fija_caja:
            self.setFixedHeight(altura_fija_caja)
        ...
        estilo = f"""
            QLineEdit {{
                border: {borde_ancho_caja}px solid {borde_color_caja};
                border-radius: {radio_caja}px;
                padding: {padding_caja}px;
                text-align: {alineacion_texto_caja};
            }}
        """
